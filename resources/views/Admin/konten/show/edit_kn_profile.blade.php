        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/konten-profile/{{$Profile->id}}" class="row g-3">
                          @method('patch')
                            @csrf
                            <div class="form-group col-md-12">
                              <label for="inputTentang">Tentang Prodi</label>
                              <textarea class="form-control  @error('tentang_prodi') is-invalid @enderror" id="inputTentang" name="tentang_prodi" value="{{$Profile->tentang_prodi}}" ></textarea>
                              @error('tentang_prodi')
