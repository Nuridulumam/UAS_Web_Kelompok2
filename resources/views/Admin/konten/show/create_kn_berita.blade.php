        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="head">
                    ...
                    <h2 class="h2 text-dark"><i class="fas fa-user-plus"></i> Tambah Berita</h2>
                </div>
                <div class="card p-2">
                    <div class="card-header">
                        <h5 class="h6 pt-2 font-weight-bold text-dark"><i class="fa fa-list"></i> Form Tambah Berita</h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="/admin/konten-berita" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            <form>
                                  <div class="form-group col-md-6">
                                    <label for="inputJudul">Judul Berita</label>
                                    <input type="text" class="form-control" id="inputJudul" name="judul_berita">
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label for="inputTanggal">Tanggal Berita</label>
                                    <input type="text" class="form-control" id="inputTanggal" name="tanggal_berita">
                                  </div>
                                ...
                                <div class="form-group col-md-12">
                                  ...
                                  <input type="text" class="form-control" id="InputIsi"  name="isi_berita">
                                </div>
                                <div class="form-group col-md-12">
