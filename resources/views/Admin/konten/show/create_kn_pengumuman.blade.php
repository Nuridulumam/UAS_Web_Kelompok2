        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card p-2">
                    ...
                    <div class="card-body">
                      <form method="POST" action="/admin/konten-pengumuman" class="row g-3">
                        @csrf
                            <div class="form-group col-md-6">
                                <label for="inputJudul">Judul Pengumuman</label>
                                <input type="text" class="form-control" id="inputJudul" name="judul_pengumuman">
                              </div>
                              <div class="form-group col-md-6">
                                <label for="inputTanggal">Tanggal Pengumuman</label>
                                <input type="text" class="form-control" id="inputTanggal" name="tanggal_pengumuman">
                              </div>
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" id="InputIsi" name="isi_pengumuman">
                            </div>
                              {{-- <div class="form-group col-md-12">
